                    ...
                    return (
                        <Fade in  key={leader._id}>
                            <div className="col-12 mt-5">
                                <Media className="leader-shadow" tag="li">
                                    <Media left middle>
                                        <Media className="leader-img" object src={baseUrl + leader.image} alt={leader.name}/>
                                    </Media>
        ...
        <div className="container">
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-md-5">
                    <Card className="facts-shadow">
                        <CardHeader className=" card-header text-white">Facts At a Glance</CardHeader>
                        <CardBody>
