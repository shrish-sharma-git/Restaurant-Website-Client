                ...
                <NavItem>
                  {!this.props.authentication.isAuthenticated ? (
                    <>
                      ...
                      <Button className="logo-style" outline onClick={this.toggleSignUpModal}>
                        <span className="fa fa-user-plus fa-lg" /> Create
                        Account
                        {this.props.signUpUser.isLoading && (
                          <span className="fa fa-spinner fa-pulse fa-fw" />
                        )}
                      </Button>
                    </>
                    ...
                    <div>
                      <div className="log-username navbar-text mr-3">
                        {this.props.authentication.user.username}
                      </div>
                      <Button className="logo-style" outline onClick={this.handleLogout}>
